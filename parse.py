...
class GoodOnYou:
    ...
    def _get_brand_tags_in(self, category) -> list:
        ...
        print('size of', category, 'is', len(brand_tags))
        return brand_tags
...
with open('brand_tags.pkl', 'rb') as f:
    brands = pickle.load(f)
data = website.data(brands[:5])
print(data.keys())
print(data)

# directory_url = 'https://directory.goodonyou.eco/brand/ftla-apparel'
# directory_url = 'https://directory.goodonyou.eco/brand/dolce-and-gabbana'